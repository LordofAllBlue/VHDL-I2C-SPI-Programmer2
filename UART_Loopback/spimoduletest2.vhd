...
-- Module  Version: 1.2
--D:\programs\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n spimoduletest2 -lang vhdl -synth synplify -bus_exp 7 -bb -type efb -arch xo2c00 -freq 50 -spi -spi_mode Both -spi_rxr -spi_txr -spi_freq 16 -spi_cs 1 -wb -dev 1200 

-- Fri Apr 18 11:19:50 2025
...
architecture Structure of spimoduletest2 is
...
begin
    ...
    EFBInst_0: EFB
        ...
        SPI_LSB_FIRST=> "DISABLED", SPI_CLK_DIVIDER=>  3, SPI_MODE=> "BOTH", 
        ...
        port map (WBCLKI=>wb_clk_i, WBRSTI=>wb_rst_i, WBCYCI=>wb_cyc_i, 
            ...
            SPIMCSN2=>open, SPIMCSN1=>open, SPIMCSN0=>spi_csn(0), 
