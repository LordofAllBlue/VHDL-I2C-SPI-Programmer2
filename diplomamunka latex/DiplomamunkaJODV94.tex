...
\subsection{SPI}
Az SPI (Serial Peripheral Interface) egy széles körben használt és rugalmas kommunikációs protokoll. Full duplex, és az UART-tal ellentétben szinkron módon működik.%done
\begin{figure}[H]
	\centering
